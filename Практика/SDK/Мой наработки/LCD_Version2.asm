...
;----------------------------высвечивание символа 1 в 4 позиции------------------------
	MOV DPTR,#0001H	  ;выбор регистра данных DATA_IND
	mov A,#80h			 ;запись данных в аккумулятор
	movx @DPTR,A			 ;Записываем данные из аккумулятора  в быранный регистр ПЛИСа
	
	MOV DPTR,#0006H 	;выбор регистра команд C_IND
	mov A,#01h          ;запись в аккумулятор данных
	movx @DPTR,A		;Запись данных в из аккумулятора в  регистр команд(RS=0,RW=0,E=1 )
	
	mov A,#00h  		;RS=0,RW=0,E=0   стираем данные из регистра команд
